...
// Get doctor details
$doctor_sql = "SELECT d.*, u.email, s.sp_name 
               FROM doctor d 
            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <span class="badge bg-primary px-3 py-2 rounded-pill">
                        <i class="bi bi-person-badge me-2"></i>Doctor ID: <?= $doctor_id ?>
                    </span>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="form-card">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <small class="text-muted"><?= $doctor['sp_name'] ?></small>
                        </div>

                        <form method="POST" action="admin_edit_doctor_1.php">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">
                                        <i class="bi bi-stethoscope text-primary me-1"></i>Specialization <span class="text-danger">*</span>
                                    </label>
                                    <select class="form-select" name="sp_id" required>
                                        ...
                                        while ($spec = mysqli_fetch_assoc($spec_rs)): ?>
                                            <option value="<?= $spec['sp_id'] ?>" 
                                                <?= ($doctor['sp_id'] == $spec['sp_id']) ? 'selected' : '' ?>>
                                                <?= $spec['sp_name'] ?>
                                            </option>
                                        <?php endwhile; ?>
                                    </select>
                                ...
                                <div class="col-12 text-center mt-4">
                                    ...
                                    <a href="admin_view_doctors.php" class="btn-back">
