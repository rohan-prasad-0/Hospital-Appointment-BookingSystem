        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="register-card shadow-lg">
                    <div class="register-header bg-danger">
                    ...
                    <div class="register-body">
                        <div class="alert alert-danger d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                Please use a different email address or <a href="login.php" class="alert-link">sign in</a>.
                            </div>
                        </div>
                        
                        <form action="register_1.php" method="post" id="registerForm">
                            <div class="row">
